...
//  Memorize
//
//  Created by Amirkhan Alpysabayev on 6/9/20.
    ...
    var body: some View {
        ...
        NavigationView{
            Grid(viewModel.cards) { card in
                            CardView(card: card)
                //                .aspectRatio(2/3, contentMode: .fit) // MARK: - TASK 3
                                .onTapGesture{
            ...
            .navigationBarItems(
                leading: Text("Score: " + String(self.viewModel.score)),
                trailing: Button("New Game", action: {
